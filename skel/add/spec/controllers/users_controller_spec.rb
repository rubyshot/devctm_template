...
describe UsersController do
  ...
  describe "GET show" do
    it "assigns the requested user as @user" do
      controller.should_receive(:current_user).at_least(1).and_return(mock_user)
      get :show
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      ...
      it "assigns the requested user as @user" do
        controller.should_receive(:current_user).at_least(1).and_return(mock_user(:update_attributes => true))
        put :update
        assigns[:user].should equal(mock_user)
      end
    ...
    describe "with invalid params" do
      ...
      it "assigns the user as @user" do
        controller.should_receive(:current_user).at_least(1).and_return(mock_user(:update_attributes => false))
        put :update
        assigns[:user].should equal(mock_user)
      end
